...
export const AI_PROVIDERS: Record<AiProviderId, AiProviderConfig> = {
  ...
  groq: {
    ...
    description: "Inferencia a velocidad récord. Soporta Llama 3.3 Versatile y DeepSeek R1 destilado.",
    ...
    models: [
      {
        ...
        description: "El modelo más potente y completo de Meta en Groq",
        hasVision: false,
        isFree: true,
      },
      {
        ...
        description: "Razonamiento matemático de DeepSeek a velocidad récord en Groq",
        hasVision: false,
        isFree: true,
      },
      {
        ...
        description: "Respuestas instantáneas en menos de 0.1 segundos",
        hasVision: false,
        isFree: true,
      },
      {
        ...
        name: "Mixtral 8x7B",
        description: "Gran ventana de contexto para análisis amplio",
        hasVision: false,
        isFree: true,
      },
    ],
    ...
    models: [
      {
        ...
        description: "Inferencia gratuita con visión para capturas de trades",
        hasVision: true,
        isFree: true,
      },
      {
      ...
      },
      {
        ...
        name: "DeepSeek V3 (Gratuito)",
        description: "Modelo versátil de DeepSeek para análisis de trading",
        hasVision: false,
        isFree: true,
      },
      {
        ...
        description: "El modelo más potente de Meta sin coste",
        hasVision: false,
        isFree: true,
      },
      {
