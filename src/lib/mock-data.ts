...
export const mockAccounts: Account[] = [
  ...
  },
  {
    ...
    maxLossLimit: 5000,
    dailyLossLimit: 3000,
    highWatermark: 102500,
    startOfDayBalance: 101800,
    drawdownLimit: 5000,
    drawdownType: "eod",
    currency: "USD",
  },
  {
    id: "acc-fundednext-burned",
    name: "FundedNext 100K — Futures",
    type: "funded",
    status: "burned",
  ...
  {
    id: "acc-apex-burned",
    name: "Apex 25K — Quemada",
    type: "funded",
    status: "burned",
    burnedAt: "2026-08-10T15:30:00.000Z",
    burnedReason: "Límite total de pérdida superado (Max Loss)",
    phase: "eval",
    profitTarget: 26500,
    firm: "Apex Trader Funding",
    initialBalance: 25000,
